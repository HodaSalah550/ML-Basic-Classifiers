...
#Set k = 3 (find the first 3 smallest distances
...
K_nearest_neighbor_classifier = Counter(KNN)
print("The unknown pattern belongs to: Class", max(K_nearest_neighbor_classifier, key=K_nearest_neighbor_classifier.get))
